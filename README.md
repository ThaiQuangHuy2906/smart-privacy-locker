...
- YC7 validated notification settings, previous-local-day email report with
  localized activity/time labels that exclude notification-delivery events,
  delivery log and database-backed duplicate suppression.
