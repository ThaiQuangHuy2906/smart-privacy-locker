...
- YC12 software-path evidence is part of `automated-results.md`; the real
  phone/ESP32 captive-portal and reconnect proof remains P1-M08/P1-M09.

Never place `.env` values, JWTs, chat IDs, email addresses, broker credentials
or service-role keys in this directory.
