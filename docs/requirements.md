...
Evidence snapshot 2026-08-17: automated software gates pass; OLED/DHT22,
...
release firmware, synchronized MQTT/UI evidence, measured power and full E2E
sequence pass. See
...
|---|---|---|---|---|
| CB2 — SG90 direct-arm close/open (`LOCK/UNLOCK` protocol compatibility) | Thái Quang Huy — 24127177 | `lock_controller`, `main`, ACK/state | native cold-boot/state test; P1-M01–P1-M03/P1-M10 manual | source/build PASS; user observed close `170°`/open `80°`; no latch/feedback, synchronized mechanical/load evidence pending |
...
|---|---|---|---|---|
| CB1 | Nguyễn Văn Minh — 24127205 | `door_sensor`, MQTT telemetry, cache/Dashboard | P2-A01/P2-S01; P2-M01/P2-M02 | automated/simulator PASS; user observed MC-38 triggering Telegram, but polarity/debounce/telemetry/UI synchronized evidence remains pending |
...
2026-08-17 audit; do not relabel them as a current deployment pass without a
new test record.
